...
categories = ['A', 'B']
channels = ['srele', 'ttbar', 'dycrele'] # 'srele', 'srmu', 'ttbar', 'dycrele', 'dycrmu'
...
CombineRunner.CreateDatacards(masspoints, categories, channels, backgrounds, systematics, 'combine_histograms_mc_fullsyst_BR_10_2018.root', signaltag)
