...
namespace uhh2examples {
  ...
  void LQTopLepFullSelectionModule::book_histograms(uhh2::Context& ctx, vector<string> tags){
  ...
  void LQTopLepFullSelectionModule::fill_histograms(uhh2::Event& event, string tag){
    string mytag = tag+"_General";
