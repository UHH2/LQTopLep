...
namespace uhh2examples {
  class LQTopLepTriggerFullselectionModule_3eTrigger: public ModuleBASE {
  public:

    explicit LQTopLepTriggerFullselectionModule_3eTrigger(Context & ctx);
  ...
  void LQTopLepTriggerFullselectionModule_3eTrigger::book_histograms(uhh2::Context& ctx, vector<string> tags){
  ...
  void LQTopLepTriggerFullselectionModule_3eTrigger::fill_histograms(uhh2::Event& event, string tag){
    string mytag = tag+"_General";
  ...
  LQTopLepTriggerFullselectionModule_3eTrigger::LQTopLepTriggerFullselectionModule_3eTrigger(Context & ctx){

    cout << "Hello World from LQTopLepTriggerFullselectionModule_3eTrigger!" << endl;
  ...
  bool LQTopLepTriggerFullselectionModule_3eTrigger::process(Event & event) {
  ...
  UHH2_REGISTER_ANALYSIS_MODULE(LQTopLepTriggerFullselectionModule_3eTrigger)
